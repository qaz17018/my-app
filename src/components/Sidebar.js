...
const Sidebar = () => {
    ...
    useEffect(() => {
        ...
        const getVar = key => getComputedStyle(document.documentElement).getPropertyValue(key)
            ...
            button.addEventListener('click', e => {
                ...
                sidebar.querySelectorAll('button.active').forEach(active => {
                    ...
                    /* if (active.querySelector('.corner')) {
                        gsap.set(active.querySelector('.corner'), {
                        ...
                        <div className='icon'>
                            <div className='top'>
                                <svg className="default" viewBox="0 0 24 13">
                                    <path
                                        d="M11.1321 11.4858L11.133 11.4864C11.6584 11.8379 12.3416 11.8379 12.867 11.4864L22.417 5.09804L22.75 4.87529V4.47466V4.2579C22.75 2.60182 21.4067 1.25 19.75 1.25H4.25C2.59331 1.25 1.25 2.60182 1.25 4.2579V4.45559V4.85556L1.58214 5.0784L11.1321 11.4858Z" />
                                </svg>
                                <svg className="inner" viewBox="0 0 24 13">
                                    <path
                                        d="M11.133 1.51361L11.1321 1.51417L1.58214 7.92157L1.25 8.14441V8.54438V11V11.75L2.00002 11.75H2.00007H2.00021H2.00076H2.00296H2.01167L2.04584 11.75L2.17721 11.75L2.66002 11.75L4.25 11.75H19.75L21.34 11.75L21.8228 11.75L21.9542 11.75L21.9883 11.75H21.997H21.9992H21.9998H21.9999H22L22.75 11.75V11V8.52531V8.12468L22.417 7.90193L12.867 1.51362C12.867 1.51361 12.867 1.5136 12.867 1.51359C12.3416 1.16213 11.6583 1.16214 11.133 1.51361Z" />
                            ...
                            <svg viewBox="0 0 24 24">
                                <defs>
                                    <clipPath id="default-clip">
                                        <path
                                            d="M3.25 4.75C3.25 3.36929 4.36929 2.25 5.75 2.25H18.25C19.6307 2.25 20.75 3.36929 20.75 4.75V22.25H3.25V4.75Z" />
                                    </clipPath>
                                </defs>
